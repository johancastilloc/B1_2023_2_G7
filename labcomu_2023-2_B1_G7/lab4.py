...
class lab4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ruido = ruido = 0
        self.h = h = [ 1]*Sps
        self.co = co = digital.constellation_calcdist((-0.707 -0.707j,-1+ 0j,0 + 1j,- 0.707 + 0.707j, 0-1j, 0.707 -0.707j, 0.707+0.707j,1-0j), [0, 1, 2, 3, 4, 5, 6, 7],
        ...
        self._ruido_range = Range(0, 1, 0.1, 0, 200)
    ...
    def get_tabla_verdad_constelacion(self):
        return self.tabla_verdad_constelacion
