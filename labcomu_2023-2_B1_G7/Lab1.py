...
class Lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = Range(0, 100, 1, 100, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, "'gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._gain_win)
        self._ff_range = Range(88e6, 107e6, 0.1e6, 88e6, 200)
        self._ff_win = RangeWidget(self._ff_range, self.set_ff, "'ff'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ff_win)
        ...
        self.uhd_usrp_source_1.set_center_freq(ff, 0)
        ...
        self.qtgui_number_sink_0_3.set_title('Desviaciòn')
        ...
        self.qtgui_number_sink_0_0.set_title('Media cuadràtica')
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.ff, self.samp_rate)
    ...
    def set_ff(self, ff):
        self.ff = ff
        self.qtgui_freq_sink_x_0.set_frequency_range(self.ff, self.samp_rate)
        self.uhd_usrp_source_1.set_center_freq(self.ff, 0)
